# Prompt de Especificación y Contenidos de la Página Principal (E:\proyectos\inicialenviosdosruedas\src\app\page.tsx)
...
#### 1. Cabecera Optimizada (src\components\layout\navbar\Navbar.tsx)
...
#### 2. Sección Principal / Hero (src\components\home\Hero.tsx)
...
#### 4. Resumen de Servicios (src\components\home\ServicesOverview.tsx)
...
#### 5. Llamado a la Acción / Conversión (src\components\home\CtaSection.tsx)
...
#### 6. Soluciones Corporativas y PyME (src\components\home\EntrepreneurSolutions.tsx)
...
#### 7. Slider de Capacidades Dinámicas (src\components\home\ServicesSlider.tsx)
...
#### 8. Carrusel de Redes Sociales (src\components\home\SocialProofTicker.tsx)
