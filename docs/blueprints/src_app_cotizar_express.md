# src/app/cotizar/express/page.tsx // Cotizador Express

## 1. MAIN TEXT CONTENT & COPYWRITING LABELS

- **Hero Anchor**:
  - Heading: "COTIZADOR EXPRESS ONLINE"
  - Subtitle: "Calculá el costo de tu envío en tiempo real con precisión geográfica."
- **Interactive Form Field (Calculator)**:
  ...
  - Result Heading: "Cotización Express"
  - Result Description: "Valores estimados basados en la ruta más óptima."
...
- [Interactive Form Field]: Multi-step form with address autocomplete.
- [Data Terminal / Table]: Results card showing distance, time, and calculated price.
...
- **Address Autocomplete**: Collects location strings and converts them to coordinates.
- **Calculate Action**: Triggers routing logic and pricing calculation.
- **Confirm Action**: Redirects user to final shipment booking (internal logic).
