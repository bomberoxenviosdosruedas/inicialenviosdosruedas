export default function TermsContent() {
  ...
  return (
    <div className="bg-white/5 border border-white/10 p-10 md:p-20 relative overflow-hidden">
      <div className="absolute top-0 right-0 p-8 font-technical text-[10px] text-accent uppercase tracking-[0.3em]">
        LEGAL_DOC_TERMS_V1.0
      </div>
      
      <div className="mb-12 border-b border-white/10 pb-8">
        <p className="font-technical text-xs text-accent mb-2 uppercase tracking-widest font-bold">Acuerdo de Servicio</p>
      ...
      <div className="space-y-12">
        {sections.map((s, i) => (
          <section key={i} className="group">
            <h3 className="font-display text-xl text-white uppercase mb-4 group-hover:text-accent transition-colors">
              {s.title}
            </h3>
