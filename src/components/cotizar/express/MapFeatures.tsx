  ...
  return (
    <section className="py-20 border-y border-white/10">
      <div className="mb-12">
        ...
        <p className="font-body text-off-white/60 max-w-2xl border-l-2 border-primary pl-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {features.map((feat) => (
          <div key={feat.id} className="group border border-white/10 p-8 hover:border-primary transition-colors bg-white/5 relative">
            <span className="absolute top-4 right-4 font-technical text-[10px] text-primary/40 group-hover:text-primary transition-colors">
              {feat.id}
            </span>
