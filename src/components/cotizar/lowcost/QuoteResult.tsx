...
export default function QuoteResult() {
  return (
    <div className="border-2 border-primary p-8 bg-primary h-full">
      <div className="mb-8 border-b border-primary/30 pb-4 flex justify-between items-end">
        <div>
          ...
          <p className="font-display text-xs text-background/60 uppercase">Step_02: Economy_Metrics</p>
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <button className="flex-1 bg-primary text-white py-4 font-mono text-lg uppercase font-bold hover:bg-white hover:text-primary transition-all">
            Confirmar Envío
          </button>
