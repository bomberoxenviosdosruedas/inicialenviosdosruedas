  ...
  return (
    <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div>
        ...
        <p className="font-display text-background/70 leading-relaxed text-lg mb-8">
          ...
          {[
            ...
            <div key={item.t} className="flex gap-6">
              ...
              <div>
                ...
                <p className="font-display text-xs text-background/50">{item.d}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="relative">
        ...
        <div className="bg-white/5 border border-white/10 p-2 relative">
          ...
          <div className="aspect-[4/5] bg-primary border border-white/10 flex flex-col justify-end p-8 overflow-hidden">
