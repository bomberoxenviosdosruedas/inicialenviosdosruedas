export default function PremiumSolutions() {
  return (
    <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div>
        <div className="bg-primary h-1 w-24 mb-8" />
        ...
        <p className="font-body text-off-white/70 leading-relaxed text-lg mb-8">
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={item.t} className="flex gap-6">
              ...
              <div>
                <h4 className="font-technical text-white uppercase text-sm mb-1 tracking-wider">{item.t}</h4>
                <p className="font-body text-xs text-off-white/50">{item.d}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="relative">
        ...
        <div className="bg-white/5 border border-white/10 p-2 relative">
          <div className="absolute top-4 left-4 font-display text-[120px] text-primary/5 select-none leading-none">
            STRAT_01
          </div>
          <div className="aspect-[4/5] bg-dark-navy border border-white/10 flex flex-col justify-end p-8 overflow-hidden">
