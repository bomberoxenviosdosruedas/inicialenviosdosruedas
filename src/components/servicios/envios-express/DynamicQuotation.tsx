...
export default function DynamicQuotation() {
  return (
    <section className="py-24 max-w-7xl mx-auto px-6">
      <div className="bg-primary border-[10px] border-primary p-12 md:p-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-8">
          <div className="bg-primary text-white font-mono text-xs px-4 py-2 uppercase tracking-[0.2em]">
            SYSTEM_LINK_005
          </div>
        </div>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="font-display text-background/70 text-lg leading-relaxed mb-8 border-l-2 border-white/20 pl-6">
            ...
            <Link href="/cotizar/express" className="inline-block bg-white text-primary px-10 py-5 font-mono text-xl uppercase font-bold hover:bg-primary hover:text-white transition-all">
              IR AL COTIZADOR
            </Link>
          </div>
          ...
          <div className="hidden lg:block relative">
            <div className="w-full aspect-square border border-white/10 bg-white/5 flex items-center justify-center p-12">
               <div className="w-full h-full border border-primary/30 flex items-center justify-center relative">
                  ...
                  <span className="font-mono text-[10px] text-primary absolute top-4 left-4">MAP_RT_442</span>
