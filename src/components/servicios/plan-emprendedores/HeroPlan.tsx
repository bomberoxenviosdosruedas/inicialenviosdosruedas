      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-8 space-y-8">
          <div className="flex items-center gap-3">
            <div className="bg-primary px-3 py-1 text-white font-mono text-xs uppercase tracking-widest font-bold">SOLUCIONES ESCALABLES</div>
          ...
          <p className="font-display text-xl text-background/80 max-w-2xl border-l-4 border-primary pl-6 py-2">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/contacto" className="bg-primary text-white px-8 py-4 font-mono text-lg uppercase font-bold hover:bg-white hover:text-primary transition-all">
              CONFIGURAR MI PLAN
            </Link>
            <Link href="/contacto" className="border border-background/30 text-white px-8 py-4 font-mono text-lg uppercase hover:bg-white/10 transition-all">
