      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          ...
          <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter">
            MÁS QUE UNA <span className="text-blue-brand">MENSAJERÍA</span>
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((b) => (
            <div key={b.id} className="bg-blue-brand border border-white/10 p-10 relative group hover:border-blue-brand transition-colors">
              <span className="font-mono text-sm text-blue-brand mb-6 block uppercase tracking-[0.2em]">{b.id}</span>
