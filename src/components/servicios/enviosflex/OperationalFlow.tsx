    ...
    <section className="py-24 bg-white/5 border-y border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {steps.map((step, i) => (
            <div key={i} className="border border-white/10 p-8 bg-primary relative group overflow-hidden">
              ...
              <p className="font-display text-xs text-background/60 leading-relaxed">
                {step.desc}
              </p>
            </div>
          ))}
