      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        <div>
          <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter">
            COMPARATIVA <br/>
            <span className="text-secondary">DE TARIFAS</span>
          </h2>
        ...
        <div className="bg-secondary px-6 py-4">
           <p className="font-mono text-primary text-xl font-bold uppercase tracking-widest">
             AHORRO MÁX. 40%
           </p>
        </div>
      </div>
        ...
        <table className="w-full border-collapse border-2 border-white/10">
          <thead>
            <tr className="bg-white/5 border-b-2 border-white/10">
              <th className="font-mono text-sm text-background uppercase p-6 text-left tracking-widest">ZONA</th>
              <th className="font-mono text-sm text-background uppercase p-6 text-left tracking-widest">TARIFA ESTÁNDAR</th>
              <th className="font-mono text-sm text-secondary uppercase p-6 text-left tracking-widest font-bold">TARIFA LOWCOST</th>
              <th className="font-mono text-sm text-primary uppercase p-6 text-left tracking-widest">AHORRO</th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((row, i) => (
              <tr key={i} className="border-b border-white/10 hover:bg-white/5 transition-colors">
                ...
                <td className="font-display text-sm text-background/40 p-6 line-through">{row.estandar}</td>
                <td className="font-display text-2xl text-secondary p-6">{row.lowcost}</td>
                <td className="p-6">
                  <span className="bg-primary/20 text-primary font-mono text-xs px-3 py-1 border border-primary/30 uppercase font-bold">
                    -{row.ahorro}
                  </span>
                </td>
              </tr>
