  ...
  return (
    <section className="py-24 bg-secondary/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <div className="inline-block bg-secondary px-3 py-1 mb-4">
          ...
          <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter">
            LA COMBINACIÓN <span className="text-secondary">PERFECTA</span>
          </h2>
          <p className="font-display text-background/60 mt-4 max-w-xl border-l-2 border-secondary pl-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((b) => (
            <div key={b.icon} className="bg-primary border border-white/10 p-10 relative group hover:border-secondary transition-colors">
              <div className="absolute top-0 right-0 p-4 font-display text-4xl text-white/5 group-hover:text-secondary/20 transition-colors">
                {b.icon}
              </div>
