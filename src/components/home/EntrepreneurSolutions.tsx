      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          <div className="lg:col-span-8 space-y-6">
            <div className="inline-flex items-center gap-3 bg-white border-4 border-primary px-4 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            <p className="font-display text-xl text-primary/60 max-w-2xl leading-tight">
          ...
          <div className="lg:col-span-4 grid grid-cols-2 gap-4">
            ...
            <div className="brutalist-card p-6 bg-secondary text-primary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {solutions.map((solution, idx) => (
            <div key={idx} className="group brutalist-card bg-white flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
              {/* Image Header */}
              <div className="relative h-48 border-b-4 border-primary overflow-hidden">
                <Image
                  src={solution.image}
                  alt={solution.title}
                  fill
                ...
                <div className="absolute top-4 left-4 bg-white border-4 border-primary p-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <div className="p-8 flex flex-col flex-grow space-y-6">
                <h4 className="font-black text-2xl text-primary uppercase tracking-tighter">
                  {solution.title}
                </h4>
                ...
                <ul className="space-y-3 flex-grow">
                  {solution.features.map((feature, fIdx) => (
                    <li key={fIdx} className="flex items-start gap-3">
                      ...
                      <span className="font-mono text-xs font-bold uppercase text-primary/70 leading-tight">
                        {feature}
                      </span>
                    </li>
                  ))}
                ...
                <Link
                  href={solution.link}
                  className="brutalist-button-primary w-full flex items-center justify-center gap-2 group-hover:bg-secondary group-hover:text-primary transition-colors"
                >
                  Configurar Plan
