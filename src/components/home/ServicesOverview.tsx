          ...
          {services.map((service, idx) => (
            <div key={idx} className="brutalist-card p-8 bg-white flex flex-col hover:-translate-y-2 transition-transform duration-300">
              <div className="mb-6 flex justify-between items-start">
                <div className="w-12 h-12 bg-primary flex items-center justify-center border-4 border-primary shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="font-display text-sm text-primary/60 font-bold uppercase tracking-tight mb-8 flex-grow">
                {service.desc}
              </p>
