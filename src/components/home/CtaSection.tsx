      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="brutalist-card bg-white p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="max-w-4xl space-y-8">
            <div className="inline-flex items-center gap-3 bg-slate-950 text-white px-4 py-2 border-4 border-slate-950 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <Zap className="w-5 h-5 text-accent animate-pulse" />
              <span className="font-mono text-xs font-bold uppercase tracking-widest">¡Empezá Ahora!</span>
            </div>

            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-slate-950 uppercase leading-none">
              ¿Listo para escalar la logística <br />
              <span className="text-primary">de tu E-Commerce?</span>
            </h2>

            <p className="font-sans text-xl md:text-2xl text-slate-600 font-bold uppercase italic max-w-2xl leading-tight">
          ...
          {/* Pillars */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-12 border-t-4 border-slate-950">
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center border-2 border-slate-950 shrink-0">
                  <pilar.icon className="w-6 h-6 text-primary" />
                </div>
                <span className="font-mono text-[10px] font-black uppercase text-slate-950 leading-tight">
                  {pilar.text}
                </span>
              </div>
            ))}
