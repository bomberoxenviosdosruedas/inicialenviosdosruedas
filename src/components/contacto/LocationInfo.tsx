  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          {schedule.map((s, i) => (
            <div key={i} className="flex justify-between items-center border-b border-white/5 pb-4">
               <span className="font-mono text-sm text-background/60 uppercase">{s.day}</span>
      ...
      <div className="bg-white/5 border border-white/10 p-10 relative overflow-hidden group">
        <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-primary">MAP_COORD_V4</div>
        ...
        <p className="font-display text-sm text-background/50 leading-relaxed mb-8">
        ...
        <button className="w-full border border-white/30 text-white py-4 font-mono text-sm uppercase font-bold hover:bg-white hover:text-primary transition-all">
