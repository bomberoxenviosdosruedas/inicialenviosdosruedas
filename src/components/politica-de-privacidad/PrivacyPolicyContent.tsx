export default function PrivacyPolicyContent() {
  ...
  return (
    <div className="bg-white/5 border border-white/10 p-10 md:p-20 relative overflow-hidden">
      <div className="absolute top-0 right-0 p-8 font-mono text-[10px] text-primary uppercase tracking-[0.3em]">
        LEGAL_DOC_PRIVACY_V1.0
      </div>
      
      <div className="mb-12 border-b border-white/10 pb-8">
        <p className="font-mono text-xs text-primary mb-2 uppercase tracking-widest font-bold">Documentación Legal</p>
