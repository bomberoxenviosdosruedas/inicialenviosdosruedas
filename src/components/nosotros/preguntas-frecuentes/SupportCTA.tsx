      ...
      <div className="bg-primary p-12 md:p-20 relative overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter mb-6 leading-none">
            ¿No encontraste <br/> <span className="text-dark-navy">lo que buscabas?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-dark-navy text-white px-10 py-5 font-technical text-xl uppercase font-bold hover:bg-white hover:text-dark-navy transition-all">
              CONTACTAR POR WHATSAPP
            </button>
            <button className="border-2 border-white text-white px-10 py-5 font-technical text-xl uppercase font-bold hover:bg-white hover:text-dark-navy transition-all">
              ENVIAR UN TICKET
            </button>
          </div>
        </div>
