    ...
    <section className="py-24 max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-5">
          ...
          <p className="font-body text-off-white/60 mb-8">Un equipo de profesionales apasionados por brindar el mejor servicio logístico de la ciudad, combinando experiencia de calle con innovación digital.</p>
        ...
        <div className="lg:col-span-7 grid grid-cols-2 gap-4">
           {roles.map((role, i) => (
             <div key={i} className="bg-white/5 border border-white/10 p-8 flex flex-col items-center justify-center text-center">
                ...
                <span className="font-technical text-xs text-white uppercase tracking-[0.2em]">{role.name}</span>
             </div>
           ))}
        </div>
      </div>
