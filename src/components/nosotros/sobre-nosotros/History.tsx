    ...
    <section className="py-24 border-y border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          ...
          <p className="font-mono text-secondary tracking-[0.2em] uppercase text-sm">Más de 7 años revolucionando la logística en Mar del Plata.</p>
        </div>
          ...
          {milestones.map((m, i) => (
            <div key={i} className="relative p-8 bg-white/5 border border-white/10 group hover:border-primary transition-colors">
               ...
               <div className="relative z-10">
                 ...
                 <p className="font-display text-xs text-background/60 leading-relaxed">{m.desc}</p>
               </div>
