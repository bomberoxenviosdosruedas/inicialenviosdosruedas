      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="font-technical text-xs tracking-[0.3em] text-accent uppercase">
          ...
          <p className="font-body text-xl text-off-white/70 max-w-2xl border-l-4 border-primary pl-8 py-2">
        ...
        {/* CTA SECTION */}
        <section className="mt-20 border-t-2 border-accent pt-20">
