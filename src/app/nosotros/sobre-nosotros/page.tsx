        ...
        <div className="max-w-7xl mx-auto px-6 text-center lg:text-left grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8 space-y-8">
            <div className="inline-block bg-primary px-3 py-1">
              <span className="font-technical text-xs text-white uppercase tracking-widest font-bold">CONOCÉ DOSRUEDAS</span>
            </div>
            ...
            <p className="font-body text-xl text-off-white/70 max-w-2xl border-l-4 border-primary pl-6 py-2">
          ...
          <div className="lg:col-span-4 grid grid-cols-1 gap-4">
             {metrics.map((m, i) => (
               <div key={i} className="border border-white/10 p-6 bg-white/5 backdrop-blur-sm relative overflow-hidden group">
                  ...
                  <p className="font-technical text-[10px] text-off-white/40 uppercase tracking-widest">{m.label}</p>
               </div>
             ))}
          </div>
        </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
               ...
               <p className="font-body text-off-white/70 text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
          {[
            ...
            <div key={i} className="bg-white/5 border border-white/10 p-12 group hover:bg-primary transition-all duration-500">
               <h3 className="font-display text-2xl text-white uppercase mb-6 group-hover:text-dark-navy transition-colors">{item.t}</h3>
               <p className="font-body text-sm text-off-white/60 leading-relaxed group-hover:text-dark-navy transition-colors">{item.d}</p>
            </div>
          ))}
        </div>
      </section>
