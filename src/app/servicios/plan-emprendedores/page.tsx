      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div>
          ...
          <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter leading-[0.85] mb-8">
            TU DEPÓSITO, <br/>
            <span className="text-blue-brand">NUESTRA GESTIÓN</span>
          </h2>
          <p className="font-display text-white-brand/70 text-lg leading-relaxed mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="flex gap-4">
                 <div className="w-1.5 h-1.5 bg-blue-brand mt-2 shrink-0" />
                 <div>
                    <h4 className="font-display text-xl text-white uppercase mb-1">{s.title}</h4>
                    <p className="font-display text-xs text-white-brand/50">{s.desc}</p>
                 </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-blue-brand/10 -z-10 translate-x-10 translate-y-10" />
          <div className="border border-white/10 p-2 bg-blue-brand">
             <div className="aspect-[4/5] bg-white/5 border border-white/10 flex flex-col justify-end p-12">
                ...
                <div className="space-y-4 relative z-10">
                  <div className="h-4 w-1/3 bg-blue-brand" />
