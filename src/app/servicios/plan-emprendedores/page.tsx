      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div>
          <div className="inline-block bg-primary px-3 py-1 mb-6">
            <span className="font-technical text-xs text-white uppercase tracking-widest font-bold">ALMACENAMIENTO Y PICKING</span>
          </div>
          ...
          <p className="font-body text-off-white/70 text-lg leading-relaxed mb-10">
            ...
            {[
              ...
              <div key={i} className="flex gap-4">
                 ...
                 <div>
                    ...
                    <p className="font-body text-xs text-off-white/50">{s.desc}</p>
                 </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative">
          ...
          <div className="border border-white/10 p-2 bg-dark-navy">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 border-t-2 border-primary">
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5">
              <div className="inline-block bg-primary px-3 py-1 mb-6">
                <span className="font-technical text-xs text-white uppercase font-bold tracking-widest">SOCIO LOGÍSTICO</span>
              </div>
              ...
              <p className="font-body text-off-white/60 text-lg mb-8">
              ...
              <div className="space-y-4">
                 <button className="w-full sm:w-auto bg-primary text-white px-10 py-5 font-technical text-xl uppercase font-bold hover:bg-white hover:text-dark-navy transition-all">
                   SOLICITAR PLAN
                 </button>
                 <button className="w-full sm:w-auto ml-0 sm:ml-4 border border-white/30 text-white px-10 py-5 font-technical text-xl uppercase hover:bg-white/10 transition-all">
