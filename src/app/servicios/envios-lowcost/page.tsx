...
export default function EnviosLowCostPage() {
  return (
    <main className="min-h-screen bg-primary text-background">
      ...
      {/* FINAL CTA */}
      <section className="py-24 max-w-7xl mx-auto px-6 border-t-2 border-secondary">
        <div className="bg-white/5 p-12 md:p-20 flex flex-col md:flex-row justify-between items-center gap-12 relative overflow-hidden">
          ...
          <div className="max-w-2xl text-center md:text-left">
            ...
            <h2 className="font-display text-5xl md:text-7xl text-white uppercase tracking-tighter mb-6 leading-none">
              ¿LISTO PARA BAJAR <br/>
              <span className="text-secondary">TUS COSTOS?</span>
            </h2>
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto shrink-0">
            <button className="bg-secondary text-primary px-10 py-5 font-mono text-xl uppercase font-bold hover:bg-white transition-all">
              COTIZAR ENVÍO
            </button>
